    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/services.jsp">Servicios</a></li>                        
            <li><a href="${pageContext.request.contextPath}/videos.jsp">Videos</a></li>                        
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">SECCION DE SERVICIOS</h3>          
        </div>
